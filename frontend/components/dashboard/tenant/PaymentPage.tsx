    ...
    <div className="container-page flex min-h-[70vh] items-center justify-center py-10">
      <div className="card w-full max-w-lg p-8">
        ...
        <p className="mt-2 text-sm leading-6 text-slate-500">
          You are about to start the payment for rental request #{rentalId}.
          Your backend should return a Stripe Checkout or SSLCommerz URL.
        </p>
        <div className="mt-6 rounded-xl bg-slate-50 p-4 text-sm text-slate-600">
          <LockKeyhole className="mr-2 inline h-4 w-4" /> Payment details are
