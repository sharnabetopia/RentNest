...
export function TenantDashboard() {
  ...
  const [reviewModal, setReviewModal] = useState<{
    isOpen: boolean;
    rentalId: string;
    property: NonNullable<Rental["property"]>;
  } | null>(null);
  ...
  return (
    <div className="container-page py-10">
      <div className="mb-8">
        ...
        <h1 className="page-title mt-1">Welcome back</h1>
        <p className="mt-2 text-slate-500">
          Track your rental journey from one place.
        </p>
      </div>
        ...
        {(
          [
            ...
            [
              MessageSquareText,
              "Active rentals",
              rentals.filter((x) => x.status === "ACTIVE").length,
            ],
          ] as [LucideIcon, string, number][]
      ...
      <section className="card mt-8 overflow-hidden">
        <div className="flex items-center justify-between border-b border-slate-200 p-5">
          <h2 className="font-bold">Rental requests</h2>
          <Link
            href="/properties"
          ...
          rentals.map((rental) => (
            ...
            >
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">Property</p>
              </div>
      ...
      <ReviewModal
        property={
          reviewModal?.property || ({} as NonNullable<Rental["property"]>)
        }
