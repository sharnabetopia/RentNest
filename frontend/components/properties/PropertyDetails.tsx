      ...
      <div className="mt-8 grid gap-8 lg:grid-cols-[1fr_360px]">
        <div>
          ...
          <div className="mt-7 flex flex-wrap gap-5 border-y border-slate-200 py-5 text-sm text-slate-600">
            ...
            <span className="flex items-center gap-2">
              <Ruler className="h-4 w-4" /> {property.bathrooms} bathrooms
            </span>
            <span className="flex items-center gap-2">
        ...
        <aside className="card h-fit p-6 lg:sticky lg:top-24">
          ...
          <p className="mt-2 text-sm leading-6 text-slate-500">
            Send a rental request to the landlord. Once approved, you can
          ...
          <Link href="/properties" className="btn-secondary mt-3 w-full">
            Back to listings
          </Link>
        </aside>
      </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/50 p-4">
          <div className="card w-full max-w-lg p-6">
            ...
            <p className="mt-1 text-sm text-slate-500">
              Tell the landlord why this property is a good fit.
            </p>
            <textarea
